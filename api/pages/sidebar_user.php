    ...
    <nav class="sidebar-nav">
        <ul>
            <li class="<?= ($page == 'dashboard' || $page == '') ? 'active' : ''; ?>">
                <a href="dashboard_user.php"><i class="fa-solid fa-chart-pie"></i><span>Dashboard</span></a>
            </li>
            <li class="<?= ($page == 'data_panen') ? 'active' : ''; ?>">
                <a href="data_panen_user.php"><i class="fa-solid fa-seedling"></i><span>Data Panen</span></a>
            </li>
        </ul>
    </nav>
</aside>
