...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .panel-logo .icon { width: 44px; height: 44px; background: rgba(255,255,255,0.2); border-radius: 12px; display: flex; align-items: center; justify-content: center; color: #fff; font-size: 20px; }
        ...
        .panel-sub { color: rgba(255,255,255,0.7); font-size: 16px; line-height: 1.7; max-width: 340px; position: relative; z-index: 1; }
        .right-panel {
            width: 480px;
            display: flex;
            justify-content: center;
