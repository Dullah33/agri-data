    ...
    <div class="reg-card">
        ...
        <div class="reg-body">
            ...
            <?php if (isset($reg_error)): ?>
                <div style="background:#FEF2F2;border:1px solid #FECACA;color:#B91C1C;padding:12px 16px;border-radius:10px;font-size:14px;margin-bottom:20px;">
                    <i class="fa-solid fa-circle-exclamation"></i> <?= htmlspecialchars($reg_error) ?>
                </div>
            <?php endif; ?>
