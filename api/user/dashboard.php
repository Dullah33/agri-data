...
<body>
    ...
    <main class="main-content">
        ...
        <div class="stat-grid">
            <?php $status_akun = $u['status'] ?? 'Active';
            ...
            <div class="stat-card-new">
                ...
                <div class="card-sub"><a href="/user/panen" style="color:#7c3aed;font-weight:700;font-size:12px;">Ke halaman Data Panen →</a></div>
            </div>
        </div>
                ...
                <div class="tips-list">
                    ...
                    <div class="tip-item">
                        ...
                        <div class="tip-text">
                            ...
                            <p>Catat hasil panen secara berkala melalui menu Data Panen untuk membantu analisis pertanian.</p>
                        </div>
                    </div>
                    <div class="tip-item">
                ...
                <table class="data-table">
                    ...
                    <tbody>
                        <?php if (!empty($data_petani_2023)): ?>
                            <?php $no = 1;
                            foreach ($data_petani_2023 as $row): ?>
                                <tr>
                                    <td style="color:#94a3b8;font-size:12px;font-weight:600;"><?= $no++ ?></td>
                                    <td>
                                        <div class="td-province">
                                            <div class="prov-dot"></div><?= htmlspecialchars($row['provinsi']) ?>
                                        </div>
                                    </td>
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="4" style="text-align:center;padding:40px;color:#94a3b8;"><i class="fa-solid fa-database" style="font-size:28px;display:block;margin-bottom:10px;color:#cbd5e1;"></i>Data BPS belum tersedia atau gagal disinkronisasi.</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
