            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><div style="max-width:200px;line-height:1.4;font-size:13px;"><?= htmlspecialchars($row['address']) ?></div></td>
                        <td>
                            <?php $status = $row['status'] ?? 'Active'; $class = ($status == 'Active') ? 'status-active' : 'status-inactive'; ?>
            ...
            <div class="two-col-grid">
                <div class="form-card">
                    <div class="section-head">
                        ...
                        <div><h3>Informasi Pribadi</h3><p>Data diri dan kontak petani</p></div>
                    </div>
                ...
                <div class="form-card">
                    <div class="section-head">
                        ...
                        <div><h3>Data Akun & Login</h3><p>Username, email, dan password</p></div>
                    </div>
            ...
            <div class="two-col-grid">
                ...
                <div class="form-card">
                    <div class="section-head">
                        ...
                        <div><h3>Data Akun</h3><p>Username, email, status</p></div>
                    </div>
