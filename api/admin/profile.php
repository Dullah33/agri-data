...
<head>
    ...
    <link rel="stylesheet" href="/assets/css/sidebar_admin.css?v=<?= time(); ?>">
    <link rel="stylesheet" href="/assets/css/topbar_admin.css?v=<?= time(); ?>">
    ...
    <div class="layout-wrapper">
        ...
        <main class="main-content">
            ...
            <div style="display: flex; justify-content: center; width: 100%;">
                ...
                <div class="profile-wrapper" style="width: 100%; max-width: 900px;">
                    ...
                    <form action="" method="POST">
                        <div class="profile-grid">
                            ...
                            <div class="profile-column-right">
                                ...
                                <div class="profile-info-card action-card">
